  ...
  try {
    ...
    const transaction1 = await prisma.transaction.create({
      data: {
        ...
        particulars: `Received payment of Sale Invoice #${req.body.sale_invoice_no} with GST ${req.body.gst} %`,
        type: "sale",
    ...
    if (req.body.discount > 0) {
      transaction2 = await prisma.transaction.create({
        data: {
          ...
          particulars: `Discount given of Sale Invoice #${req.body.sale_invoice_no}  with GST ${req.body.gst} %`,
          type: "sale",
          related_id: parseInt(req.body.sale_invoice_no),
        },
      });
